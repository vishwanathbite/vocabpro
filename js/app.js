...
function loadIdiomsDB() {
  ...
  _idiomsLoadPromise = new Promise((resolve, reject) => {
    ...
    script.src = 'js/data/idioms.js?v=39';
    script.onload = () => {
...
function App() {
  ...
  useEffect(() => {
    const titles = {
      home: 'VocabPro — Master 5,900+ Vocabulary Items for Competitive Exams',
