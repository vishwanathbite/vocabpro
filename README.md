...
Master **2,858 vocabulary items** with a gamified learning experience designed specifically for Indian exam aspirants.

## ✨ Features

### 📖 Comprehensive Content
- **2,657 Vocabulary Words:**
  - Easy: 474 words (foundational vocabulary)
  - Medium: 1,718 words (intermediate level)
...
|----------|-------|------------|
| Easy Words | 474 | Foundation building |
| Medium Words | 1,718 | Core vocabulary |
| Hard Words | 465 | Advanced learning |
| Acronyms | 103 | Quick recall |
| One-Word Subs | 98 | Exam patterns |
| **TOTAL** | **2,858** | **Complete coverage** |
...
Currently at **2,858 items** | Goal: **5,000+ comprehensive vocabulary**
