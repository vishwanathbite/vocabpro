...
// Activity Badges
{
  ...
  icon: '🤔',
  condition: stats => stats.totalAnswered >= 50
}, {
  id: 'questions_100',
  ...
  icon: '🎓',
  condition: stats => stats.totalAnswered >= 250
}, {
  id: 'questions_500',
  name: 'Knowledge Seeker',
  description: 'Answer 500 questions',
  icon: '🔍',
  condition: stats => stats.totalAnswered >= 500
}, {
  id: 'questions_1000',
  name: 'Eternal Student',
  description: 'Answer 1000 questions',
  icon: '📚',
  condition: stats => stats.totalAnswered >= 1000
},
// Accuracy Badges
{
  id: 'accuracy_50',
  name: 'Good Start',
  description: 'Maintain 50% accuracy (min 20 questions)',
  icon: '✅',
  condition: stats => stats.totalAnswered >= 20 && stats.correctAnswers / stats.totalAnswered >= 0.5
}, {
  id: 'accuracy_75',
  name: 'Sharp Mind',
  description: 'Maintain 75% accuracy (min 50 questions)',
  icon: '🎯',
  condition: stats => stats.totalAnswered >= 50 && stats.correctAnswers / stats.totalAnswered >= 0.75
}, {
  id: 'accuracy_90',
  name: 'Perfection',
  description: 'Maintain 90% accuracy (min 100 questions)',
  icon: '⭐',
  condition: stats => stats.totalAnswered >= 100 && stats.correctAnswers / stats.totalAnswered >= 0.9
},
// Special Badges
{
  id: 'referral',
  ...
  description: 'Try all quiz modes',
  icon: '🎭',
  condition: stats => stats.modesPlayed >= 6
},
...
// Idiom Badges
{
  id: 'idiom_first',
  name: 'Phrase Hunter',
  description: 'Complete your first idioms quiz',
  icon: '💬',
  condition: stats => stats.idiomsQuizzesCompleted >= 1
}, {
  id: 'idiom_master',
  name: 'Idiom Master',
  description: 'Score 100% in an idioms quiz',
  icon: '🏅',
  condition: stats => stats.idiomsPerfectScore >= 1
}, {
  id: 'idiom_wordsmith',
  name: 'Wordsmith',
  description: 'Complete idioms quiz in all 3 difficulties',
  icon: '✍️',
  condition: stats => stats.idiomsDifficultiesCompleted >= 3
}];
...
const updateStats = (stats, isCorrect, difficulty, word, mode) => {
  ...
  newStats.averageAccuracy = newStats.totalAnswered > 0 ? newStats.correctAnswers / newStats.totalAnswered * 100 : 0;
...
const StreakProtection = {
  ...
  checkStreak: (stats, lastPlayedDate) => {
    ...
    if (lastPlayedDay === todayStr || lastPlayedDay === yesterdayStr) {
      ...
      return {
        protected: false,
        shieldsRemaining: StreakProtection.getShields()
      };
    }
