...
const DailyChallengeManager = {
  ...
  generateQuestions() {
    ...
    const idiomQuestions = idiomWords.map(item => {
      ...
      const distractorPool = idiomPool.filter(d => d.meaning !== item.meaning).map(d => d.meaning);
...
function App() {
  ...
  const [isSignedUp, setIsSignedUp] = useState(() => {
    try {
      return localStorage.getItem('vocabProSignedUp') === 'true';
    } catch (e) {
      return false;
    }
  });
  const [signedUpName, setSignedUpName] = useState(() => {
    try {
      return localStorage.getItem('vocabProUserName') || '';
    } catch (e) {
      return '';
    }
  });
  const [signedUpEmail, setSignedUpEmail] = useState(() => {
    try {
      return localStorage.getItem('vocabProUserEmail') || '';
    } catch (e) {
      return '';
    }
  });
  ...
  const generateQuestions = (quizMode, quizDifficulty, useSRS = true) => {
    ...
    if (quizMode === 'vocab') {
      ...
      const selectedWords = useSRS && typeof selectSRSOptimizedWords === 'function' ? selectSRSOptimizedWords(words, count) : sample(words, count);
      ...
      const selectedItems = useSRS && typeof selectSRSOptimizedWords === 'function' ? selectSRSOptimizedWords(oneWordDB, count) : sample(oneWordDB, count);
      ...
      const selectedItems = useSRS && typeof selectSRSOptimizedWords === 'function' ? selectSRSOptimizedWords(acronymsDB, count) : sample(acronymsDB, count);
      generatedQuestions = selectedItems.map(item => {
      ...
      const idiomPool = quizDifficulty ? idiomsDB.filter(item => item.difficulty === quizDifficulty) : idiomsDB;
      if (idiomPool.length === 0) {
        console.warn(`No idioms found for difficulty: ${quizDifficulty}`);
        return [];
      }
      const selectedItems = useSRS && typeof selectSRSOptimizedWords === 'function' ? selectSRSOptimizedWords(idiomPool, count) : sample(idiomPool, count);
      generatedQuestions = selectedItems.map(item => {
        if (!item || !item.idiom || !item.meaning) return null;
        // Build distractor pool from other idiom meanings
        const distractorPool = idiomsDB.filter(d => d.meaning !== item.meaning).map(d => d.meaning);
      ...
      generatedQuestions = selectedItems.map(item => {
        if (!item || !item.idiom || !item.meaning) return null;
        const distractorPool = idiomsDB.filter(d => d.idiom !== item.idiom).map(d => d.idiom);
        const distractors = sample(distractorPool, 3);
      ...
      const dueWords = typeof SRSManager !== 'undefined' && SRSManager.getDueWords ? SRSManager.getDueWords(allWords, count) : sample(allWords, count);
      ...
      const bookmarkedWords = typeof BookmarksManager !== 'undefined' && BookmarksManager.getForPractice ? BookmarksManager.getForPractice(count) : [];
  ...
  const handleStartDailyChallenge = async () => {
    ...
    try {
      await loadVocabDifficulty('medium');
    } catch (e) {/* non-critical */}
    try {
      await loadVocabDifficulty('hard');
    } catch (e) {/* non-critical */}
    try {
      await loadIdiomsDB();
    } catch (e) {/* non-critical — challenge works without idioms */}
    await new Promise(resolve => setTimeout(resolve, 300));
  ...
  const handleDailyChallengeComplete = () => {
    ...
    const {
      streak,
      bestStreak
    } = DailyChallengeManager.completeChallenge(correctCount, totalQ, points);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(LoadingOverlay, {
    isVisible: isLoading,
    message: loadingMessage
  }), showAchievement && /*#__PURE__*/React.createElement("div", {
    role: "alert",
    "aria-live": "assertive"
  }, /*#__PURE__*/React.createElement(AchievementNotification, {
    badge: showAchievement,
    onClose: () => setShowAchievement(null)
  })), showLevelUp && /*#__PURE__*/React.createElement(LevelUpNotification, {
    levelInfo: showLevelUp,
    onClose: () => setShowLevelUp(null)
  }), showStreakMilestone && /*#__PURE__*/React.createElement(StreakMilestone, {
  ...
  }, screen === 'onboarding' ? /*#__PURE__*/React.createElement(OnboardingScreen, {
  ...
  }) : screen === 'history' ? /*#__PURE__*/React.createElement(QuizHistoryScreen, {
    onBack: () => setScreen('home')
  }) : screen === 'analytics' ? /*#__PURE__*/React.createElement(AnalyticsDashboard, {
    stats: stats,
    onBack: () => setScreen('home')
  ...
  }) : screen === 'flashcard' ? /*#__PURE__*/React.createElement(FlashcardScreen, {
    cards: flashcards,
    onBack: handleBack,
    onComplete: handleFlashcardComplete
  }) : screen === 'match' ? /*#__PURE__*/React.createElement(MatchGameScreen, {
    pairs: matchPairs,
    ...
    difficulty: difficulty
  }) : /*#__PURE__*/React.createElement(QuizScreen, {
    mode: mode,
    difficulty: difficulty,
    questions: questions,
  ...
  })), showDailyChallengeResults && dailyChallengeResult && /*#__PURE__*/React.createElement(DailyChallengeResultsScreen, {
  ...
  }), /*#__PURE__*/React.createElement(DifficultyModal, {
    ...
    mode: pendingMode
  }), currentUser && /*#__PURE__*/React.createElement(ShareModal, {
  ...
  }, "You've earned ", stats.totalPoints, " points! Create an account to save your progress and unlock badges."), /*#__PURE__*/React.createElement(PrimaryButton, {
    onClick: () => {
      setShowSignupReminder(false);
      setShowAuthModal(true);
    },
    className: "w-full mb-3"
  }, "Create Account"), /*#__PURE__*/React.createElement(SecondaryButton, {
    onClick: () => setShowSignupReminder(false),
    className: "w-full"
  }, "Maybe Later"))), /*#__PURE__*/React.createElement(SearchModal, {
    ...
    title: "Quiz Complete!",
    maxWidth: "max-w-lg"
  }, quizResults && /*#__PURE__*/React.createElement("div", {
    className: "text-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-6xl mb-4 animate-bounce-in"
  }, quizResults.accuracy >= 80 ? '🎉' : quizResults.accuracy >= 60 ? '👍' : '💪'), /*#__PURE__*/React.createElement("h3", {
    className: "text-2xl font-bold text-white mb-2"
  }, quizResults.accuracy >= 80 ? 'Excellent!' : quizResults.accuracy >= 60 ? 'Good Job!' : 'Keep Practicing!'), /*#__PURE__*/React.createElement("p", {
    className: "text-white text-opacity-70 mb-6"
  }, quizResults.correctCount, "/", quizResults.totalQuestions, " correct answers"), /*#__PURE__*/React.createElement("div", {
  ...
  }, "+", quizResults.score)), /*#__PURE__*/React.createElement("div", {
    className: "bg-white bg-opacity-10 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-white text-opacity-70 text-sm"
  }, "Accuracy"), /*#__PURE__*/React.createElement("p", {
    className: `text-3xl font-bold ${quizResults.accuracy >= 80 ? 'text-green-400' : quizResults.accuracy >= 60 ? 'text-yellow-400' : 'text-red-400'}`
  }, quizResults.accuracy, "%")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white bg-opacity-10 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-white text-opacity-70 text-sm"
  }, "Total Points"), /*#__PURE__*/React.createElement("p", {
    className: "text-2xl font-bold text-green-400"
  }, quizResults.totalPoints)), /*#__PURE__*/React.createElement("div", {
    className: "bg-white bg-opacity-10 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-white text-opacity-70 text-sm"
  }, "Level"), /*#__PURE__*/React.createElement("p", {
    className: "text-xl font-bold text-white"
  }, quizResults.levelInfo.badge, " ", quizResults.levelInfo.name))), /*#__PURE__*/React.createElement("div", {
    ...
    width: "18",
    height: "18"
  }), /*#__PURE__*/React.createElement("span", null, "Share Results")), /*#__PURE__*/React.createElement(PrimaryButton, {
    onClick: handleCloseQuizComplete,
    className: "flex-1"
  }, "Continue Learning")))));
}
...
const MatchGameScreen = React.memo(({
  ...
  const getCardClass = (item, type) => {
    ...
    const isWrong = wrongPair && (type === 'word' && wrongPair.wordId === item.id || type === 'definition' && wrongPair.defId === item.id);
  ...
  if (complete) {
    ...
    }, "Match Game Complete!"))), /*#__PURE__*/React.createElement("main", {
    ...
    }, "Great Job!"), /*#__PURE__*/React.createElement("div", {
    ...
    }, formatTime(timer))), /*#__PURE__*/React.createElement("div", {
      className: "bg-white bg-opacity-10 rounded-xl p-4"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-white text-opacity-70 text-sm"
    }, "Wrong Attempts"), /*#__PURE__*/React.createElement("p", {
      className: "text-2xl font-bold text-red-400"
    }, wrongCount)), /*#__PURE__*/React.createElement("div", {
      className: "bg-white bg-opacity-10 rounded-xl p-4"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-white text-opacity-70 text-sm"
    }, "First Try"), /*#__PURE__*/React.createElement("p", {
      className: "text-2xl font-bold text-green-400"
    }, firstTryCount, "/5")), /*#__PURE__*/React.createElement("div", {
      className: "bg-white bg-opacity-10 rounded-xl p-4"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-white text-opacity-70 text-sm"
    }, "Score"), /*#__PURE__*/React.createElement("p", {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xl font-bold text-white"
  }, "Match Game"), /*#__PURE__*/React.createElement("div", {
  ...
  }, formatTime(timer)))))), /*#__PURE__*/React.createElement("main", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, wordItem.word), matched.includes(wordItem.id) && /*#__PURE__*/React.createElement(Check, {
      width: "16",
      height: "16",
      ...
      className: "text-white text-opacity-90 text-xs sm:text-sm leading-snug"
    }, defItem.definition), matched.includes(defItem.id) && /*#__PURE__*/React.createElement(Check, {
      width: "16",
      height: "16",
      className: "inline ml-2 text-green-400"
    })));
  })), /*#__PURE__*/React.createElement("div", {
    className: "mt-6 flex items-center justify-center gap-6 text-white text-sm"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    "aria-live": "polite",
    "aria-atomic": "true"
  }, "Matches: ", matched.length, "/", pairs.length)), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
